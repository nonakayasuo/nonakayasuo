...
【プロダクト概要】投資アプリケーションの開発において、ユーザーの投資データを収集・分析・可視化し、個別の投資パフォーマンスや市場傾向のレポートを提供するシステムを構築。

【チームの特徴・課題】

- チーム全体でデータ収集から分析、結果の可視化、提供までを一貫して担当

- Python のデータ分析ライブラリ（numpy, pandas）や可視化ライブラリ（matplotlib, seaborn）を活用して効率的な分析を実施

- ユーザー体験を向上させるためのリアルタイムなデータ更新機能を実装
